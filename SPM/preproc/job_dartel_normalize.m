...
% Inputs :
%     template   : the final template generated by "job_do_dartel_template" in the firts subject folder [ex: tamplate_6.nii]
%                  can be a cellarray or volume object         
%     flow_field : the files generated by "job_do_dartel_template" [u_.*nii] for each subject
%                  can be a cellarray or volume object
%     images     : images to normalize for each subject. Use "get_subdir_regex_files" to selecte more files
%                  can be a cellarray or volume object
%     par        : parameters 
%
% Outputs :
