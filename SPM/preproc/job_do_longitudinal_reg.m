...
for nbsuj = 1:tot_number_suj
    ...
    if par.cat12
        ...
        jobs{nbsuj}.spm.tools.cat.long.opts.tpm = {'/network/lustre/iss02/cenir/software/irm/spm12/tpm/TPM.nii'};
        ...
        jobs{nbsuj}.spm.tools.cat.long.extopts.registration.T1 = {'/network/lustre/iss02/cenir/software/irm/spm12/toolbox/cat12/templates_MNI152NLin2009cAsym/T1.nii'};
        jobs{nbsuj}.spm.tools.cat.long.extopts.registration.brainmask = {'/network/lustre/iss02/cenir/software/irm/spm12/toolbox/cat12/templates_MNI152NLin2009cAsym/brainmask.nii'};
        jobs{nbsuj}.spm.tools.cat.long.extopts.registration.cat12atlas = {'/network/lustre/iss02/cenir/software/irm/spm12/toolbox/cat12/templates_MNI152NLin2009cAsym/cat.nii'};
        jobs{nbsuj}.spm.tools.cat.long.extopts.registration.darteltpm = {'/network/lustre/iss02/cenir/software/irm/spm12/toolbox/cat12/templates_MNI152NLin2009cAsym/Template_1_Dartel.nii'};
        jobs{nbsuj}.spm.tools.cat.long.extopts.registration.shootingtpm = {'/network/lustre/iss02/cenir/software/irm/spm12/toolbox/cat12/templates_MNI152NLin2009cAsym/Template_0_GS.nii'};
