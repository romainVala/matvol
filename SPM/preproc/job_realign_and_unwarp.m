...
for subj = 1:nrSubject
    ...
    for run = 1:length(subjectRuns)
        ...
        if ~par.redo   &&   exist(lastrun_filenames_cellstr{1},'file')
            ...
            jobs{2*subj-1}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsval.mflags.template = {'/network/lustre/iss02/cenir/software/irm/spm12/toolbox/FieldMap/T1.nii'};
