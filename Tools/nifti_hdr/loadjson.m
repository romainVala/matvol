...
% "x0x[Hex code]_" will be added if the first character is not a letter.
    ...
    if(~isoct)
        if strfind(str,'CsaImage.')
            str=str(10:end);
        elseif strfind(str,'CsaSeries.MrPhoenixProtocol.')
            str=str(29:end);
           
        elseif strfind(str,'CsaSeries.')
            str=str(11:end);
        ...
        if length(str)>62
            ...
            str=regexprep(str,'([^0-9A-Za-z_])','_');
