...
util.values  = { spm_cfg_aslsubtract spm_cfg_disp spm_cfg_checkreg spm_cfg_imcalc spm_cfg_reorient spm_cfg_voi spm_cfg_dicom spm_cfg_minc spm_cfg_ecat spm_cfg_spm_surf spm_cfg_cdir spm_cfg_md spm_cfg_movefile spm_cfg_deletefiles spm_cfg_defs spm_cfg_print spm_cfg_cat spm_cfg_exp_frames};
% ---------------------------------------------------------------------
% tools Tools
% ---------------------------------------------------------------------
tools         = cfg_choice;
